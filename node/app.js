...
function receivedMessage(event) {
  ...
  userprofilename = getUserProfile(senderID);

  console.log("Received message for user %d and page %d at %d with message:",
    senderID, recipientID, timeOfMessage);
  console.log(JSON.stringify(message));
  
  console.log("Capture the Event----------"+JSON.stringify(event));
  ...
  if (isEcho) {
	...
	switch (quickReplyPayload) {
	  ...
	  case 'showbalance':
			sendMyFirst(senderID);
			break;
		
	  case 'Topupmobile':
			requiresServerURL(sendTopUpurl, [senderID]);
			break;
		
	  case 'TransferMoney':    
			sendQuickOption(senderID);
			break;
		
	  case 'SavingTransferTrigger':     
			from = "Savings";			
			sendQuickPayOption(senderID);
			break;
      case 'transferfromwallet':
			from = "Wallet";
			sendQuickPayOption(senderID);
			break;
	  case 'Transferfromdebitcard':  
			from = "Debit Card";
			sendQuickPayOption(senderID);
			break;
	  ...
	  case 'TransferToBhanu': 
			to = "Bhanu";
			sendConfirmation(senderID);
			break;
      case 'TransferToHarsh':
			to = "harsh";
			sendConfirmation(senderID);
			break;  
	  case 'TransferToVineet':  
			to = "Vineet";
			sendConfirmation(senderID);
			break;
			
	  case 'transfernow': 
			sendTextMessage(senderID, "The transfer completed successfully! Your confirmation number is xxxxxxxxxxx");
			break;
...
function requiresServerURL(next, [recipientId, ...args]) {
  if (SERVER_URL === "https://bcpooghwuw.localtunnel") {
    var messageData = {
      recipient: {
        id: recipientId
      },
  ...
  var messageData = {
    ...
    message: {
      attachment: {
        type: "image",
        payload: {
          url: "http://www.pngmart.com/files/2/Mario-PNG-Image.png"
        }
      }
    }
  };
       ...
       quick_replies: [
        {
          "content_type":"text",
          "title":"Savings",
          "payload":"SavingTransferTrigger"
        },
        {
          "content_type":"text",
          "title":"Wallet",
          "payload":"transferfromwallet"   
        },
        {
          "content_type":"text",
          "title":"DebitCard",
          "payload":"Transferfromdebitcard"
        }
      ]
    }
  };
  ...
  var messageData = {
    ...
    message: {
      attachment: {
        ...
        payload: {
          template_type: "button",
          text: "Hello "+userprofilename+",How can I help you",
          buttons:[{
            type: "postback",
            title: "show balance",
            payload: "showbalance"
 ...
 *
 */
function sendTopUpurl(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
      ...
      attachment: {
        ...
        payload: {
          ...
          elements: [{
            title: "Top up here",
            subtitle: "Paytm kro",
            item_url: "www.paytm.com/",
            image_url: SERVER_URL + "/assets/rift.png",
            buttons: [{
              type: "web_url",
              url: "https://paytm.com/",
              title: "Click to Topup"
            }, {
              type: "postback",
              title: "GOTOMAIN",
              payload: "Payload for first bubble",
 ...
 *
 */
function sendQuickOption(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
 ...
 *
 */
function sendToWhich(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
    message: {
      text: "To which account do you want to transfer?",
      quick_replies: [
        {
          "content_type":"text",
          "title":"Bhanu",
          "payload":"TransferToBhanu"
        },
        {
          "content_type":"text",
          "title":"Harsh",
          "payload":"TransferToHarsh"   
        },
        {
          "content_type":"text",
          "title":"Vineet",
          "payload":"TransferToVineet"
        }
      ]
    }
  };
...
Amount: `+amount+` dollar From: `+from+` To: `+to+`
      `,
          buttons:[{
            type: "postback",
            title: "Transfer Now",
...
/**/
 ...
 // Api Response to msg
function sendMyFirst(recipientId) {
  request({
